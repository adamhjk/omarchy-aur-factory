...
/**
 * Inline omarchy wordmark (public/omarchy-logo.svg), inlined as a component
 * rather than an <img> so its `fill="currentColor"` paths pick up the
 * surrounding text color.
 */
export function OmarchyLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
